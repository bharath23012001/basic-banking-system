<HTML>
<head>
	<title>The Sparks Banking</title>
...
<body style="background-image: url('cust.jpg');">
	...
	<div align="center" style="top:0px">
		<table width="1330">
            <tr>
			<td><h1 style="font-family: gabriola; text-color: ">The Sparks Banking</h1>
			</td>
            </tr>
	...
	<div>
		<img src="cust.jpg" alt="Forest" height="500" style="opacity:0.5">
	</div>
